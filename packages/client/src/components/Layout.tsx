    ...
    <footer className="border-t mt-auto">
      <div className="container mx-auto px-4 py-6">
        <p className="text-xs text-muted-foreground text-center leading-relaxed">
          ...
          None of the content is hosted on this server. All links redirect to
          external sources. Use at your own discretion. We do not guarantee the
          safety of any downloads.
        </p>
      </div>
    </footer>
  );
